...
export default class ListaProduto extends Component<{}, table> {
    ...
    public async deletaServico(id: any): Promise<boolean> {
        let retorno = false
        await axios.delete('http://localhost:2001/DeletaProduto/' + id).then(resposnse => {
