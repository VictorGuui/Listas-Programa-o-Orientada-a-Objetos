...
var cli4 = new cliente_1.default('Belinha', 'Bela', new cpf_1.default('73454542354', new Date(12, 12, 1221)), 'Feminino');
var cli5 = new cliente_1.default('Vasco', 'Gigante', new cpf_1.default('28426645454', new Date(12, 12, 1221)), 'Masculino');
var cli6 = new cliente_1.default('Pedro', 'Pussy', new cpf_1.default('39454475554', new Date(12, 12, 1221)), 'Masculino');
var cli7 = new cliente_1.default('Hugo', 'Hugas', new cpf_1.default('14454877456', new Date(12, 12, 1221)), 'Masculino');
var cli8 = new cliente_1.default('Ulquiora', 'Ciffer', new cpf_1.default('52452245451', new Date(12, 12, 1221)), 'Feminino');
...
var cli11 = new cliente_1.default('Dalva', 'Mae', new cpf_1.default('56554745895', new Date(12, 12, 1221)), 'Feminino');
...
var servico4 = new servico_1.default("Massagem relaxante", 45);
var servico5 = new servico_1.default("Tratamento capilar", 30);
var servico6 = new servico_1.default("Pedicure e Manicure", 40);
...
var produto4 = new produto_1.default("Sabonete Esfoliante", 8);
var produto5 = new produto_1.default("Óleo Corporal", 18);
var produto6 = new produto_1.default("Máscara Facial", 25);
